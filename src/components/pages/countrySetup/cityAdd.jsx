...
export default function CityAdd() {
    ...
    const submitHandler = async (e) => {
        ...
        if (!formdata.parent_id) {
            newErrors.parent_id = "Country is required";
        }
        if (!formdata.DESC1) {
            newErrors.DESC1 = "City name is required";
        }
                ...
                <div className="pagetitle">
                    ...
                    <nav>
                        <ol className="breadcrumb">
                            ...
                            <li className="breadcrumb-item active">City Setup</li>
                        </ol>
                    </nav>
                </div>
                {/* End Page Title */}
                                    ...
                                    <form method="post" onSubmit={submitHandler}>
                                        <div className="row mb-3">
                                            ...
                                            <div className="col-sm-7">
                                                <select value={formdata?.parent_id || ''} className={`form-control ${errors.parent_id ? 'is-invalid' : ''}`} name="parent_id" onChange={(e) => setFormdata({ ...formdata, [e.target.name]: e.target.value })}>
                                        ...
                                        <div className="row mb-3">
                                            ...
                                            <div className="col-sm-7">
                                                <input value={formdata?.DESC1 || ''} type="text" className={`form-control ${errors.DESC1 ? 'is-invalid' : ''}`} name="DESC1" onChange={(e) => setFormdata({ ...formdata, [e.target.name]: e.target.value })} />
                                                {errors.DESC1 && (
                                        ...
                                        <div>
                                            <Link to="/city" className="btn btn-secondary">
                                                Back
                                            </Link>&nbsp;
